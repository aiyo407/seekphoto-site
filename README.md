...
<p align="center">
  ...
  <a href="#-核心功能">核心功能</a> &nbsp;•&nbsp;
  <a href="#-为什么选SeekPhoto">为什么选SeekPhoto</a> &nbsp;•&nbsp;
  <a href="#-快速开始">快速开始</a>
</p>
...
![SeekPhoto界面预览](docs/preview.png)
...
SeekPhoto是一款**完全本地运行**的 AI 照片搜索与管理工具。无需上传云端，无需联网，所有数据处理都在你的设备上完成。
...
1. 访问 [SeekPhoto官网](https://www.seekphoto.cn)
...
**自动适配**：SeekPhoto启动时会按硬件自动选择最优后端并立即生效，无需手动切换。
...
SeekPhoto是闭源的专有软件，源码不对外公开，暂时无法接受外部代码贡献。但非常欢迎：
- 💡 提出功能建议
- 🐛 报告 Bug
- 🌍 翻译界面
...
SeekPhoto 是**专有闭源软件**，源码不对外公开。完整条款见仓库根目录的 [LICENSE](./LICENSE)。
...
<p align="center">
  <b>如果SeekPhoto对你有帮助，欢迎把它推荐给同样需要的朋友，并在 GitHub 上点个 ⭐</b><br />
  <i>由个人开发者用 ❤️ 制作</i>
</p>
